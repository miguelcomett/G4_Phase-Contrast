...
void PepiActionInitialization::Build() const
{
  ...
  PepiRunAction* runAction = new PepiRunAction(false);
  SetUserAction(runAction);
  PepiEventAction* pepiEventAction = new PepiEventAction(fDetector,runAction); 
  SetUserAction(pepiEventAction);
  PepiSteppingAction *pepiSteppingAction = new  PepiSteppingAction(pepiEventAction);
  SetUserAction(pepiSteppingAction);
