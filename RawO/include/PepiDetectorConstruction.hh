...
class PepiDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    void SetThreshold(G4double, G4double, G4double, G4double, G4double, G4double, G4double, G4double);
    ...
    void Move(G4String, G4LogicalVolume*, G4VPhysicalVolume*, G4ThreeVector,G4LogicalVolume*, G4double);
    void Move1(G4String, G4LogicalVolume*, G4VPhysicalVolume*, G4ThreeVector,G4LogicalVolume*, G4double);
    ...
    G4double GetThreshold3() const {return fThreshold3;}
    G4double GetThreshold4() const {return fThreshold4;}
    G4double GetThreshold5() const {return fThreshold5;}
    G4double GetThreshold6() const {return fThreshold6;}
    G4double GetThreshold7() const {return fThreshold7;}
    G4double GetThreshold8() const {return fThreshold8;}
  ...
  private:
    ...
    G4Tubs*  fObjectSolid;
    G4Tubs*  fObject2Solid;
    G4Tubs*  fObject3Solid;
    G4Tubs*  fObject4Solid;
    G4Sphere* Pore;
    G4Tubs* fSphereSolid;
    ...
    G4LogicalVolume* fObject4Logical;
    ...
    G4VPhysicalVolume* fObject4Physical;
    ...
    G4double fThreshold3;
    G4double fThreshold4;
    G4double fThreshold5;
    G4double fThreshold6;
    G4double fThreshold7;
    G4double fThreshold8;
