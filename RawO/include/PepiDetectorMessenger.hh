...
class PepiDetectorMessenger: public G4UImessenger
{
  ...
  private:
    ...
    G4UIcmdWithADoubleAndUnit*  fThreshold3Cmd;
    G4UIcmdWithADoubleAndUnit*  fThreshold4Cmd;
    G4UIcmdWithADoubleAndUnit*  fThreshold5Cmd;
    G4UIcmdWithADoubleAndUnit*  fThreshold6Cmd;
    G4UIcmdWithADoubleAndUnit*  fThreshold7Cmd;
    G4UIcmdWithADoubleAndUnit*  fThreshold8Cmd;
